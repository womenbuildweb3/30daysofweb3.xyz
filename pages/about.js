        ...
        <section className="pt-8 mb-44">
          <div className="sm:w-1/2">
            <p className="mb-16 sm:text-xl">
              Our collective is composed of software engineers, designers,
              content creators, technical writers, managers, and founders with
              ...
              to decentralize the internet and to bring more diverse
              perspectives to web3.
            </p>
          </div>
          <div className="flex justify-end">
            <div className="sm:w-1/2">
              <p className="mb-8 sm:text-xl">
                We aim to support underrepresented women and non-binary
                developers in web3 with education, opportunities, and funding.
                We want at least 70% of our initial cohort to transition into
                web3 full-time within a year. Learn more about our goals in our
                whitepaper.
              </p>
