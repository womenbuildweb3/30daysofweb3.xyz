...
export default function Blog({ myData }) {
  return (
    ...
    <div className={styles.container}>
      <Navbar />
      <div className="max-w-3xl mx-auto pt-6 flex flex-col justify-center items-start max-w-5xl border-gray-200 dark:border-gray-700 mx-auto pb-60">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {myData.publication.posts.map((post) => (
            <div className="flex flex-col text-gray-500">
              <h1 className="w-full mb-2 text-lg font-medium text-gray-900 md:text-xl dark:text-gray-100">
                {post.title}
              </h1>
