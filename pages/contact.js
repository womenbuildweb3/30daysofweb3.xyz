      ...
      <div className="mt-4 mx-4 sm:mx-16">
        ...
        <main className="md:grid md:grid-cols-2 md:gap-8 md:mx-auto md:max-w-4xl">
          <header className="mb-8">
            ...
            <p className="mb-4">
              For curious developers, we are opening up memberships once we
              build a solid foundation for our organization. In the meantime,
              say hi!
            </p>
            <p className="mb-4">
          ...
          {submitted && (
            <div className="mt-20 text-center">
              Your message was succesflly sent! We will do our best to get back
              to you soon.
            </div>
          )}
        </main>
