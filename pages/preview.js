      ...
      <div className="my-16 mx-auto max-w-7xl px-4 sm:my-24">
        <h1 className="text-center text-4xl tracking-tight font-extrabold text-slate-900 sm:text-5xl md:text-6xl mb-12">
          ...
          <span className="sm:block text-royal-600">
            {locale !== "es" ? "30 Days of Web3" : "30 Días de Web3"}
          </span>
        </h1>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc space-y-4 pl-8">
                  ...
                  <li>
                    {locale !== "es"
                      ? "Intro to Wallets"
                      : "Introducción a Billeteras Virtuales"}
                  </li>
                  <li>
                    {locale !== "es"
                      ? "Setup Your Wallet"
                ...
                <ul className="list-disc space-y-4 pl-8">
                  <li>
                    {locale !== "es"
                      ...
                      : "Definición de Nuestra Estructura de Datos"}
                  </li>
                  <li>
                    {locale !== "es"
                      ? "Defining Functions"
                  ...
                  <li>
                    {locale !== "es"
                      ...
                      : "Escribiendo un Script de Prueba"}
                  </li>
                </ul>
              </div>
              <div className="space-y-4">
                <span className="font-bold">
                  {locale !== "es"
                    ...
                    : "Desplegando Tu Smart Contract"}
                </span>
                <ul className="list-disc space-y-4 pl-8">
                  <li>
                    {locale !== "es"
                      ? "Deploying with Infura"
                      : "Despliegue con Infura"}
                  </li>
                  <li>
                    {locale !== "es"
                ...
                <ul className="list-disc space-y-4 pl-8">
                  ...
                  <li>
                    {locale !== "es"
                      ...
                      : "Agregar conexión de Wallet"}
                  </li>
                  <li>
                    {locale !== "es"
                      ? "Intro to Web3.Storage"
                      : "Introducción a Web3.Storage"}
                  </li>
                  <li>
                    {locale !== "es"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <ul className="list-disc space-y-4 pl-8">
                  <li>
                    {locale !== "es"
                      ...
                      : "El Patio de Juegos de The Graph"}
                  </li>
                  <li>
                    {locale !== "es"
                      ? "Querying Your Subgraph"
                      : "Consultando tu Subgraph"}
                  </li>
                  <li>
                    {locale !== "es"
                      ? "Fetching Event Details"
                      : "Obteniendo Detalles de Tu Evento"}
                  </li>
                  <li>
                    {locale !== "es"
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc space-y-4 pl-8">
                  ...
                  <li>
                    {locale !== "es"
                      ? "Social Graphs with Lens Protocol"
                      : "Graphs Sociales con Lens Protocol"}
                  </li>
                </ul>
              </div>
              <div className="space-y-4">
                <span className="font-bold">
                  {locale !== "es" ? "Wrapping Up" : "Conclusión"}
                </span>
                <ul className="list-disc space-y-4 pl-8">
                  <li>
                    {locale !== "es"
                      ? "Social Graphs with Lens"
                      : "Social Graphs with Lens"}
                  </li>
                  <li>
                    {locale !== "es"
                      ? "Host Your Code With Radicle"
                      : "Control De Versiones Con Radicle"}
                  </li>
                </ul>
              </div>
            </div>
