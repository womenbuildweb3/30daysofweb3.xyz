...
export default function Home() {
  return (
    <div className="mt-4 mx-16">
      ...
      <header className="mt-8 mb-44 grid gap-8">
        <div className="grid font-poppins-bold text-6xl leading-tight">
          <div>1 DAO</div>
        ...
        <div className="flex justify-end">
          <div className="block max-w-xl">
            ...
            <Link href="/contact" passHref>
              <a className="hover:text-white hover:bg-black border border-black border-solid rounded-full text-2xl px-4 py-3">
                Join us
              </a>
            </Link>
          </div>
      ...
      <section className="mb-44 grid grid-cols-2 gap-8">
        <div>
          <p className="leading-normal mb-8 text-2xl">
          ...
          <Link href="/contact" passHref>
            <a className="hover:text-white hover:bg-black border border-black border-solid rounded-full text-lg px-4 py-3">
              Join us
            </a>
          </Link>
        </div>
        ...
        <div>
          <h3 className="text-3xl font-poppins-semi-bold">
            Our Core Intiatives
          </h3>
          <hr className="my-8 border-t border-black border-solid" />
          <h3 className="mb-4 text-3xl font-poppins-semi-bold">
            &#128218; Education
          </h3>
      ...
      <section className="max-w-5xl mb-44 grid grid-cols-2 m-auto gap-8">
        <div>
          <ol className="list-disc last:pb-0">
            <li className="m-3 text-lg">Day 1: Blockchain refresher</li>
            <div className="h-6 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-lg">Day 4: Intro to The Graph</li>
            <div className="h-12 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-lg">Day 13: Deploying with a L2</li>
            <div className="h-10 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-lg">Day 22: Integrating Livepeer</li>
            <div className="h-8 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-lg">Day 30: Demo Day</li>
          </ol>
        </div>

        <div>
          <h2 className="text-5xl font-poppins-bold mb-8">
            Ramp up in 30 days
          </h2>
          <p className="mb-8 leading-normal text-2xl">
      ...
      <section className="mb-44">
        <div className="mb-16 flex flex-col flex-center max-w-2xl mx-auto">
          <h2 className="mb-8 text-center text-5xl font-poppins-bold">
            Building in public
          </h2>
          ...
          <Link href="/blog" passHref>
            <a className="hover:text-white hover:bg-black mx-auto border border-black border-solid rounded-full text-lg px-4 py-3">
              View our blog
            </a>
          </Link>
        </div>
        <div className="flex gap-8">
          ...
          <div>
            <Link href="/blog" passHref>
              <h3 className="cursor-pointer leading-normal text-2xl font-poppins-bold">
            ...
            <Link href="/blog" passHref>
              <div className="mt-4 flex items-end gap-2">
                ...
                <div className="cursor-pointer text-xl">Author Name</div>
              </div>
            </Link>
          </div>
