    ...
    <div className="mt-4 mx-4 sm:mx-16">
      ...
      <section className="mb-44 grid sm:grid-cols-2 gap-8">
        <div>
          ...
          <Link href="/contact" passHref>
            <a className="hover:text-white hover:bg-black border border-black border-solid rounded-full text-xs sm:text-lg px-4 py-3">
              Join us
            </a>
          </Link>
        </div>
      ...
      <section className="max-w-5xl mb-44 flex flex-col-reverse sm:flex-row m-auto gap-8">
        <div className="mx-auto sm:mx-0 sm:w-1/2">
          <ol className="list-disc last:pb-0">
            <li className="m-3 text-base sm:text-lg">Day 1: Blockchain refresher</li>
            <div className="h-6 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-base sm:text-lg">Day 4: Intro to The Graph</li>
            <div className="h-12 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-base sm:text-lg">Day 13: Deploying with a L2</li>
            <div className="h-10 w-20 border-l border-black border-dashed" />
            <li className="m-3 text-base sm:text-lg">Day 22: Integrating Livepeer</li>
      ...
      <section className="mb-44">
        <div className="mb-16 flex flex-col flex-center max-w-2xl mx-auto">
          ...
          <Link href="/blog" passHref>
            <a className="hover:text-white hover:bg-black mx-auto border border-black border-solid rounded-full text-xs sm:text-lg px-4 py-3">
              View our blog
            </a>
          </Link>
        </div>
          ...
          <div>
            ...
            <Link href="/blog" passHref>
              <div className="mt-4 flex items-end gap-2">
                ...
                <div className="cursor-pointer text-base sm:text-xl">Author Name</div>
              </div>
            </Link>
          </div>
